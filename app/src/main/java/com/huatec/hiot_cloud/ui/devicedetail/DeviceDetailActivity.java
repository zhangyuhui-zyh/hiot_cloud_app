...
public class DeviceDetailActivity extends BaseActivity<DeviceDatailView, DeviceDatailPresenter> implements DeviceDatailView {

    @Inject
    DeviceDatailPresenter presenter;
    ...
    @Override
    public DeviceDatailPresenter createPresenter() {
